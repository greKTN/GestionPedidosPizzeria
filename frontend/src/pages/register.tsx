...
export default function Login() {
    ...
    // estados independientes para mostrar y oocultar las contraseñas en ambos campos //
            ...
            <div className='flex w-full max-w-4xl overflow-hidden rounded-2x1 bg-[#c8d4ef] shadow-2x1 md:flex-row flex-col'>
                ...
                <div className='flex flex-col justify-center flex-1 px-8 py-12 md:px-16 text-center'>
                    ...
                    <h2 className='text-3x1 font-semibold tracking-tight text-zinc-900 md:text-4x1'>
                        Crea tu cuenta en Pizza Panucci's
                    </h2>
                    <p className='mt-2 text-base text-zinc-600'>
                        Registrate para disfrutar de las mejores pizzas y promociones exclusivas. ¡Es rápido y fácil!
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className='mt-8 space-y-4 text-left'>
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-lg bg-[#1e5aa3] py-3 font-medium text-white shadow-md transition-colors hover:bg-[#164680] active:scale-[0.99] mt-2">
                            Registrarse
                        </button>

                        {/*enlace para retornar al login*/}
